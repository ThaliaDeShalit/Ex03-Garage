...
namespace Ex03.GarageLogic
{
    class ElectricCar : Car
    {
        ...
        public ElectricCar(string i_Model, string i_LicenceNumber, string i_WheelManufactorName, float i_CurrentAirPressure, eCarColor i_CarColor, eAmountOfDoors i_NumOfCarDoors)
